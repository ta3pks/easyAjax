var ajax = {
	...
	post: function(e, t, s) {
		...
		n.addEventListener("readystatechange", function() {
			4 == this.readyState && 200 == this.status ? s(!1, this.response, !1) : 422 == this.status?s(!0, this.response, !1): 404 == this.status && s({"code":"1","message":"page not found","status":"404"}, !1, !1)
